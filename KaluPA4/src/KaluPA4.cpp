...
#include "llclass2.hpp"
#include "student.hpp"

int main() {
LL <Student> ll1;
cout << "main: length of empty list - " << ll1.list_length() << 
endl;
ll1.display_list();
Student temp;
temp.data = "aaaaa";
...
temp.key = 45678;
ll1.push_back(temp);
cout << "main: length of list after 4 pushes - " << 
...
cout << "main: length of list after delete - " << ll1.list_length() 
<< endl;
